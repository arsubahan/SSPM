...
var sagscroller_constants={
	navpanel: {height:'16px', downarrow:'images/down2.gif', opacity:0.6, title:'Go to Next Content', background:'black'},
	loadingimg: {src:'images/ajaxloading.gif', dimensions:[100,15]}
}

function sagscroller(options){

	this.setting={mode:'auto', inittype:'stunted', pause:3000, animatespeed:500, ajaxsource:null, rssdata:null, refreshsecs:0, navpanel:{show:true, cancelauto:false}} //default settings
