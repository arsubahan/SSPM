(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    function isStorageSupported($window, storageType) {
      ...
      // when accessing window.sessionStorage. This happens before you try to do anything with it. Catch
      ...
      // When Safari (OS X or iOS) is in private browsing mode, it appears as though sessionStorage and sessionStorage
